...
import { EmbeddingAssisted } from '../classes/embeddingAssisted';
...
export class AssistedService {
  ...
  // }
  getEmbededAssisteds(volunteer: Volunteer): Observable<Array<EmbeddingAssisted>> {
    return this.http.post<Array<EmbeddingAssisted>>(this.url + "/GetEmbededAssisteds", volunteer);
  }
  sendMessagesToAssisteds(embeddingAssisteds: EmbeddingAssisted[]): Observable<boolean> {
    return this.http.post<boolean>(this.url + "/SendMessagesToAssisteds", embeddingAssisteds);
  }
